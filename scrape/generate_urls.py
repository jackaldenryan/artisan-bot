...
# # Remove any url that has the string "terms-of-use" or "privacy-policy" in it
# urls = [url for url in urls if "terms-of-use" not in url and "privacy-policy" not in url and "talk-to-sales" not in url]
